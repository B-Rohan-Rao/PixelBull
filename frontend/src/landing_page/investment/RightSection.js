...
export default function RightSection({imageUrl, productName, productDescription, link1, link1text, link2, link2text}){
    return (
            ...
            <div className='row mt-2'>
                <div className='col-5 p-4'>
                    ...
                    <div className='mt-2 fs-7 px-4'>
                        ...
                        {link2 && (
                            <a style={{textDecoration: "none", marginLeft:"100px"}} className='text-muted' href={link2}>
                                {link2text}<i className="fa fa-long-arrow-right" aria-hidden="true"></i>
                            </a>
                        )}
                    </div>
                </div>
